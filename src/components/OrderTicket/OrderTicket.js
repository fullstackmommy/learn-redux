...
const STATUSES = ["pending", "fulfilled", "paid"];
      ...
      <table className="order-ticket__table">
        <tbody>
          <tr className="order-ticket__name-and-status">
            <td>
              <strong className="order-ticket__name">{customerName}</strong>
            </td>
            <td>
              <select
                className="order-ticket__status"
                value={status}
          ...
          <tr className="order-ticket__product-info">
            <td colSpan={2}>
              <strong>{cone ? "Cone" : "Cup"}</strong> — {totalScoops} scoops
            </td>
          </tr>
          {flavorRows}
        </tbody>
